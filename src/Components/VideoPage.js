      ...
      <div className="videoSub">
        ...
        <span>
          {obj.subscription === "no" ? (
            <button
              ...
              onClick={() => videoDispatch({ type: "subscribe", obj })}
            >
              Subscribe
            </button>
          ) : (
            <button
              onClick={() => videoDispatch({ type: "subscribed", obj })}
        ...
        {obj.isVideoLiked === "no" && (
          <button
            ...
            onClick={() => videoDispatch({ type: "addToLiked", obj })}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
        ...
        {obj.isVideoLiked === "yes" && (
          <button
            className="bi bi-hand-thumbs-upButton"
            onClick={() => videoDispatch({ type: "removeFromLiked", obj })}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
        ...
        {obj.watchLater === "no" && (
          <button
            ...
            onClick={() => videoDispatch({ type: "addToWatchLater", obj })}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
        ...
        {obj.watchLater === "yes" && (
          <button
            className="bi bi-stopwatch"
            onClick={() => videoDispatch({ type: "removeFromWatchLater", obj })}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
